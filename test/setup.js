...
global.document = new JSDOM('<!doctype html><html><body><script></script></body></html>').window.document;
...
global.window.matchMedia =
  ...
  global.console.error = (firstArg, ...args) => {
    ...
    if (typeof firstArg === 'string' && firstArg.startsWith('Warning: Failed prop type:')) {
      return;
    }
